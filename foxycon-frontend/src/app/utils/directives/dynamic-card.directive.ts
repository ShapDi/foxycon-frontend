import { ComponentRef, Directive, Injector, Input, OnChanges, SimpleChanges, ViewContainerRef } from "@angular/core";
...
export class DynamicCardDirective implements OnChanges {
    ...
    async ngOnChanges() {
        ...
        const componentRef = this.viewContainerRef.createComponent(componentType, { injector: customInjector });
